...
var o = (e2, t2, i2, s2 = "") => {
  ...
  return n2.className = i2, n2.innerHTML = s2, e2.appendChild(n2), n2;
};
var l = (e2) => {
...
var w = b.default = function(e2) {
  if (e2) {
    var t2 = function(e3) {
    ...
    }, i2 = 0, s2 = 1, a2 = 2, n2 = 3, r2 = [], o2 = null, l2 = "requestAnimationFrame" in e2 ? function() {
      ...
      return e3.dirty !== a2 || e3.dirty === a2 && e3.element.parentNode.clientWidth !== e3.availableWidth;
    }, v2 = function(t3) {
      ...
      e2.clearTimeout(k2), k2 = e2.setTimeout(d2(a2), P2.observeWindowDelay);
  ...
  function x2(e3, t3) {
    var i3 = y({}, A2, t3), s3 = e3.map(function(e4) {
      ...
      }(t4), { element: e4, fit: b2(t4, n2), unfreeze: E2(t4), freeze: R2(t4), unsubscribe: w2(t4) };
    });
    return l2(), s3;
  }
  function P2(e3) {
    var i3 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    return typeof e3 == "string" ? x2(t2(document.querySelectorAll(e3)), i3) : x2([e3], i3)[0];
  }
  ...
  load(e2, i2 = {}) {
    ...
    if (s2) {
      ...
      if (s2.hasAttribute("data-loaded") === false) {
        ...
        } else if (a2 && i2.excludeIframes !== true) {
...
var R = class {
  ...
  getSlideNumber(e2 = this.Reveal.getCurrentSlide()) {
    ...
    if (typeof i2.slideNumber == "function")
      ...
      let a3 = e2 && e2.dataset.visibility === "uncounted" ? 0 : 1;
      switch (t2 = [], s2) {
        case "c":
...
var A = class {
  ...
  sync(e2) {
    ...
    if (n2) {
      const t3 = S(n2);
      t3 && t3.a !== 0 && (typeof (r2 = n2) == "string" && (r2 = S(r2)), (r2 ? (299 * r2.r + 587 * r2.g + 114 * r2.b) / 1e3 : null) < 128 ? e2.classList.add("has-dark-background") : e2.classList.add("has-light-background"));
    }
    var r2;
  }
  update(e2 = false) {
    ...
    if (Array.from(this.element.childNodes).forEach((i3, o2) => {
      i3.classList.remove("past", "present", "future"), o2 < s2.h ? i3.classList.add(n2) : o2 > s2.h ? i3.classList.add(r2) : (i3.classList.add("present"), a2 = i3), (e2 || o2 === s2.h) && t(i3, ".slide-background").forEach((e3, t2) => {
        e3.classList.remove("past", "present", "future"), t2 < s2.v ? e3.classList.add("past") : t2 > s2.v ? e3.classList.add("future") : (e3.classList.add("present"), o2 === s2.h && (a2 = e3));
      });
  ...
  updateParallax() {
    ...
    if (this.Reveal.getConfig().parallaxBackgroundImage) {
      ...
      n2.length === 1 ? t2 = i2 = parseInt(n2[0], 10) : (t2 = parseInt(n2[0], 10), i2 = parseInt(n2[1], 10));
...
var x = class {
  ...
  run(e2, t2) {
    ...
    if (e2.hasAttribute("data-auto-animate") && t2.hasAttribute("data-auto-animate") && e2.getAttribute("data-auto-animate-id") === t2.getAttribute("data-auto-animate-id") && !(s2 > a2 ? t2 : e2).hasAttribute("data-auto-animate-restart")) {
      ...
      let n2 = this.getAutoAnimatableElements(e2, t2).map((e3) => this.autoAnimateElements(e3.from, e3.to, e3.options || {}, i3, C++));
      if (t2.dataset.autoAnimateUnmatched !== "false" && this.Reveal.getConfig().autoAnimateUnmatched === true) {
        ...
        this.getUnmatchedAutoAnimateElements(t2).forEach((e4) => {
          ...
          t3.duration === i3.duration && t3.delay === i3.delay || (s4 = "unmatched-" + C++, n2.push(`[data-auto-animate="running"] [data-auto-animate-target="${s4}"] { transition: opacity ${t3.duration}s ease ${t3.delay}s; }`)), e4.dataset.autoAnimateTarget = s4;
        }, this), n2.push(`[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity ${e3}s ease ${s3}s; }`);
      }
      this.autoAnimateStyleSheet.innerHTML = n2.join(""), requestAnimationFrame(() => {
  ...
  autoAnimateElements(e2, t2, i2, s2, a2) {
    ...
    i2.delay !== void 0 && (n2.delay = i2.delay), i2.duration !== void 0 && (n2.duration = i2.duration), i2.easing !== void 0 && (n2.easing = i2.easing);
    ...
    if (i2.translate !== false || i2.scale !== false) {
      ...
      let s3 = i2.translate !== false && (t3.x !== 0 || t3.y !== 0), a3 = i2.scale !== false && (t3.scaleX !== 0 || t3.scaleY !== 0);
      if (s3 || a3) {
        let e4 = [];
  ...
  getAutoAnimatableProperties(e2, t2, i2) {
    ...
    return (i2.styles || s2.autoAnimateStyles).forEach((t3) => {
      let i3;
      typeof t3 == "string" && (t3 = { property: t3 }), i3 = t3.from !== void 0 && e2 === "from" ? { value: t3.from, explicitValue: true } : t3.to !== void 0 && e2 === "to" ? { value: t3.to, explicitValue: true } : n2[t3.property], i3 !== "" && (a2.styles[t3.property] = i3);
    }), a2;
  }
  ...
  update(e2, t2) {
    ...
    if (s2 && this.Reveal.getConfig().fragments && (t2 = t2 || this.sort(s2.querySelectorAll(".fragment"))).length) {
      ...
      Array.from(t2).forEach((t3, s3) => {
        if (t3.hasAttribute("data-fragment-index") && (s3 = parseInt(t3.getAttribute("data-fragment-index"), 10)), a2 = Math.max(a2, s3), s3 <= e2) {
          let a3 = t3.classList.contains("visible");
          t3.classList.add("visible"), t3.classList.remove("current-fragment"), s3 === e2 && (this.Reveal.announceStatus(this.Reveal.getStatusText(t3)), t3.classList.add("current-fragment"), this.Reveal.slideContent.startEmbeddedContent(t3)), a3 || (i2.shown.push(t3), this.Reveal.dispatchEvent({ target: t3, type: "visible", bubbles: false }));
        } else {
      ...
      }), e2 = typeof e2 == "number" ? e2 : -1, e2 = Math.max(Math.min(e2, a2), -1), s2.setAttribute("data-fragment", e2);
    }
    return i2;
  }
...
var D = class {
  ...
  getIndicesFromHash(e2 = window.location.hash) {
    ...
    if (/^[0-9]*$/.test(i2[0]) || !t2.length) {
      ...
      let t3, s2 = e3.hashOneBasedIndex ? 1 : 0, a2 = parseInt(i2[0], 10) - s2 || 0, n2 = parseInt(i2[1], 10) - s2 || 0;
      return e3.fragmentInURL && (t3 = parseInt(i2[2], 10), isNaN(t3) && (t3 = void 0)), { h: a2, v: n2, f: t3 };
    }
    {
      let e3, i3;
  ...
  getHash(e2) {
    ...
    if (this.Reveal.getConfig().fragmentInURL || (a2.f = void 0), typeof s2 == "string" && s2.length)
      ...
      if (i2 === 0)
        ...
        s2 = () => {
          ...
          if (typeof e3.init == "function") {
            ...
            t3 && typeof t3.then == "function" ? t3.then(a2) : a2();
          } else
            a2();
        }, s2();
      }
...
var q = class {
  ...
  async setupPDF() {
    const e2 = this.Reveal.getConfig(), i2 = t(this.Reveal.getRevealElement(), ".slides section"), s2 = e2.slideNumber && /all|print/i.test(e2.showSlideNumber), a2 = this.Reveal.getComputedSlideSize(window.innerWidth, window.innerHeight), n2 = Math.floor(a2.width * (1 + e2.margin)), r2 = Math.floor(a2.height * (1 + e2.margin)), o2 = a2.width, d2 = a2.height;
    ...
    i2.forEach(function(i3, a3) {
      if (i3.classList.contains("stack") === false) {
        ...
        if (g2.push(m2), m2.className = "pdf-page", m2.style.height = (r2 + e2.pdfPageHeightOffset) * p2 + "px", h2 && (m2.style.background = h2), m2.appendChild(i3), i3.style.left = l2 + "px", i3.style.top = c3 + "px", i3.style.width = o2 + "px", this.Reveal.slideContent.layout(i3), i3.slideBackgroundElement && m2.insertBefore(i3.slideBackgroundElement, i3), e2.showNotes) {
          ...
          if (t2) {
            const i4 = 8, s3 = typeof e2.showNotes == "string" ? e2.showNotes : "inline", a4 = document.createElement("div");
            a4.classList.add("speaker-notes"), a4.classList.add("speaker-notes-pdf"), a4.setAttribute("data-layout", s3), a4.innerHTML = t2, s3 === "separate-page" ? g2.push(a4) : (a4.style.left = i4 + "px", a4.style.bottom = i4 + "px", a4.style.width = n2 - 2 * i4 + "px", m2.appendChild(a4));
          }
        }
        if (s2) {
          const e3 = a3 + 1, t2 = document.createElement("div");
  ...
  onTouchMove(e2) {
    ...
    if (this.touchCaptured)
      ...
      if (e2.touches.length === 1 && this.touchStartCount !== 2) {
        ...
        n2 > 40 && Math.abs(n2) > Math.abs(r2) ? (this.touchCaptured = true, t2.navigationMode === "linear" ? t2.rtl ? this.Reveal.next() : this.Reveal.prev() : this.Reveal.left()) : n2 < -40 && Math.abs(n2) > Math.abs(r2) ? (this.touchCaptured = true, t2.navigationMode === "linear" ? t2.rtl ? this.Reveal.prev() : this.Reveal.next() : this.Reveal.right()) : r2 > 40 && a2.up ? (this.touchCaptured = true, t2.navigationMode === "linear" ? this.Reveal.prev() : this.Reveal.up()) : r2 < -40 && a2.down && (this.touchCaptured = true, t2.navigationMode === "linear" ? this.Reveal.next() : this.Reveal.down()), t2.embedded ? (this.touchCaptured || this.Reveal.isVerticalSlide()) && e2.preventDefault() : e2.preventDefault();
      }
    }
  }
  onTouchEnd(e2) {
...
function V(n2, l2) {
  ...
  const h2 = {};
  let u2, g2, p2, m2, b2, y2 = {}, w2 = false, S2 = { hasNavigatedHorizontally: false, hasNavigatedVertically: false }, L2 = [], C2 = 1, z2 = { layout: "", overview: "" }, V2 = {}, $2 = "idle", j2 = 0, X = 0, Y = -1, _ = false, J = new E(h2), Q = new R(h2), Z = new x(h2), G = new A(h2), ee = new P(h2), te = new N(h2), ie = new M(h2), se = new D(h2), ae = new I(h2), ne = new T(h2), re = new F(h2), oe = new H(h2), le = new q(h2), de = new O(h2), ce = new B(h2), he = new U(h2);
  function ue(e2) {
    if (!n2)
      throw 'Unable to find presentation root (<div class="reveal">).';
    if (V2.wrapper = n2, V2.slides = n2.querySelector(".slides"), !V2.slides)
  ...
  function ge() {
    y2.embedded === true ? V2.viewport = r(n2, ".reveal-viewport") || n2 : (V2.viewport = document.body, document.documentElement.classList.add("reveal-full-page")), V2.viewport.classList.add("reveal-viewport");
  }
  function ve() {
    w2 = true, pe(), me(), Re(), we(), Ee(), it(), Se(), se.readURL(), G.update(true), setTimeout(() => {
  ...
  function me() {
    V2.slides.classList.add("no-transition"), v ? V2.wrapper.classList.add("no-hover") : V2.wrapper.classList.remove("no-hover"), G.render(), Q.render(), ae.render(), ne.render(), he.render(), V2.pauseOverlay = o(V2.wrapper, "div", "pause-overlay", y2.controls ? '<button class="resume-button">Resume presentation</button>' : null), V2.statusElement = fe(), V2.wrapper.setAttribute("role", "application");
  }
  function fe() {
  ...
  function Pe(e2) {
    typeof e2.layout == "string" && (z2.layout = e2.layout), typeof e2.overview == "string" && (z2.overview = e2.overview), z2.layout ? a(V2.slides, z2.layout + " " + z2.overview) : a(V2.slides, z2.overview);
  }
  function Ne({ target: t2 = V2.wrapper, type: i2, data: s2, bubbles: a2 = true }) {
    let n3 = document.createEvent("HTMLEvents", 1, 2);
    return n3.initEvent(i2, a2, true), e(n3, s2), t2.dispatchEvent(n3), t2 === V2.wrapper && Me(i2), n3;
  }
  function Me(t2, i2) {
  ...
  function Fe(e2) {
    typeof e2 == "boolean" ? e2 ? ze() : He() : V2.overlay ? He() : ze();
  }
  function ze() {
    if (y2.help) {
  ...
  function qe() {
    if (V2.wrapper && !le.isPrintingPDF()) {
      if (!y2.disableLayout) {
        ...
        const e2 = Oe(), t2 = C2;
        Be(y2.width, y2.height), V2.slides.style.width = e2.width + "px", V2.slides.style.height = e2.height + "px", C2 = Math.min(e2.presentationWidth / e2.width, e2.presentationHeight / e2.height), C2 = Math.max(C2, y2.minScale), C2 = Math.min(C2, y2.maxScale), C2 === 1 ? (V2.slides.style.zoom = "", V2.slides.style.left = "", V2.slides.style.top = "", V2.slides.style.bottom = "", V2.slides.style.right = "", Pe({ layout: "" })) : C2 > 1 && f && window.devicePixelRatio < 2 ? (V2.slides.style.zoom = C2, V2.slides.style.left = "", V2.slides.style.top = "", V2.slides.style.bottom = "", V2.slides.style.right = "", Pe({ layout: "" })) : (V2.slides.style.zoom = "", V2.slides.style.left = "50%", V2.slides.style.top = "50%", V2.slides.style.bottom = "auto", V2.slides.style.right = "auto", Pe({ layout: "translate(-50%, -50%) scale(" + C2 + ")" }));
        ...
        t2 !== C2 && Ne({ type: "resize", data: { oldScale: t2, scale: C2, size: e2 } });
      }
  ...
  function Xe() {
    if (y2.pause) {
      ...
      St(), V2.wrapper.classList.add("paused"), e2 === false && Ne({ type: "paused" });
    }
  }
  function Ye() {
    const e2 = V2.wrapper.classList.contains("paused");
  ...
  function Qe(e2) {
    typeof e2 == "boolean" ? e2 ? kt() : At() : _ ? kt() : At();
  }
  function Ze() {
    return !(!j2 || _);
  }
  function Ge(e2, t2, i2, s2) {
    if (Ne({ type: "beforeslidechange", data: { indexh: e2 === void 0 ? u2 : e2, indexv: t2 === void 0 ? g2 : t2, origin: s2 } }).defaultPrevented)
      return;
    p2 = m2;
    const a2 = V2.wrapper.querySelectorAll(".slides>section");
    if (a2.length === 0)
      return;
    t2 !== void 0 || te.isActive() || (t2 = We(a2[e2])), p2 && p2.parentNode && p2.parentNode.classList.contains("stack") && Ue(p2.parentNode, g2);
    const n3 = L2.concat();
    L2.length = 0;
    let r2 = u2 || 0, o2 = g2 || 0;
    u2 = at(".slides>section", e2 === void 0 ? u2 : e2), g2 = at(".slides>section.present>section", t2 === void 0 ? g2 : t2);
    let l3 = u2 !== r2 || g2 !== o2;
    l3 || (p2 = null);
    let d2 = a2[u2], c2 = d2.querySelectorAll("section");
    m2 = c2[g2] || d2;
    let h3 = false;
    l3 && p2 && m2 && !te.isActive() && (p2.hasAttribute("data-auto-animate") && m2.hasAttribute("data-auto-animate") && p2.getAttribute("data-auto-animate-id") === m2.getAttribute("data-auto-animate-id") && !(u2 > r2 || g2 > o2 ? m2 : p2).hasAttribute("data-auto-animate-restart") && (h3 = true, V2.slides.classList.add("disable-slide-transitions")), $2 = "running"), nt(), qe(), te.isActive() && te.update(), i2 !== void 0 && ee.goto(i2), p2 && p2 !== m2 && (p2.classList.remove("present"), p2.setAttribute("aria-hidden", "true"), $e() && setTimeout(() => {
      gt().forEach((e3) => {
        Ue(e3, 0);
      });
    }, 0));
    ...
    for (; n3.length; )
      V2.viewport.classList.remove(n3.pop());
    l3 && Ne({ type: "slidechanged", data: { indexh: u2, indexv: g2, previousSlide: p2, currentSlide: m2, origin: s2 } }), !l3 && p2 || (J.stopEmbeddedContent(p2), J.startEmbeddedContent(m2)), requestAnimationFrame(() => {
      be(ye(m2));
    }), ne.update(), ae.update(), he.update(), G.update(), G.updateParallax(), Q.update(), ee.update(), se.writeURL(), Rt(), h3 && (setTimeout(() => {
      V2.slides.classList.remove("disable-slide-transitions");
    }, 0), y2.autoAnimate && Z.run(p2, m2));
  }
  function et() {
    ke(), Ae(), qe(), j2 = y2.autoSlide, Rt(), G.create(), se.writeURL(), ee.sortAll(), ae.update(), ne.update(), nt(), he.update(), he.updateVisibility(), G.update(true), Q.update(), J.formatEmbeddedContent(), y2.autoPlayMedia === false ? J.stopEmbeddedContent(m2, { unloadIframes: false }) : J.startEmbeddedContent(m2), te.isActive() && te.layout();
  }
  function tt(e2 = m2) {
  ...
  function at(e2, i2) {
    let s2 = t(V2.wrapper, e2), a2 = s2.length, n3 = le.isPrintingPDF();
    if (a2) {
      y2.loop && (i2 %= a2) < 0 && (i2 = a2 + i2), i2 = Math.max(Math.min(i2, a2 - 1), 0);
      for (let e4 = 0; e4 < a2; e4++) {
        let a3 = s2[e4], r3 = y2.rtl && !Ke(a3);
        a3.classList.remove("past"), a3.classList.remove("present"), a3.classList.remove("future"), a3.setAttribute("hidden", ""), a3.setAttribute("aria-hidden", "true"), a3.querySelector("section") && a3.classList.add("stack"), n3 ? a3.classList.add("present") : e4 < i2 ? (a3.classList.add(r3 ? "future" : "past"), y2.fragments && t(a3, ".fragment").forEach((e5) => {
          e5.classList.add("visible"), e5.classList.remove("current-fragment");
        })) : e4 > i2 && (a3.classList.add(r3 ? "past" : "future"), y2.fragments && t(a3, ".fragment.visible").forEach((e5) => {
          e5.classList.remove("visible", "current-fragment");
        }));
      }
  ...
  function nt() {
    let e2, i2, s2 = ht(), a2 = s2.length;
    if (a2 && u2 !== void 0) {
      let n3 = te.isActive() ? 10 : y2.viewDistance;
      v && (n3 = te.isActive() ? 6 : y2.mobileViewDistance), le.isPrintingPDF() && (n3 = Number.MAX_VALUE);
      for (let r2 = 0; r2 < a2; r2++) {
        let o2 = s2[r2], l3 = t(o2, "section"), d2 = l3.length;
        if (e2 = Math.abs((u2 || 0) - r2) || 0, y2.loop && (e2 = Math.abs(((u2 || 0) - r2) % (a2 - n3)) || 0), e2 < n3 ? J.load(o2) : J.unload(o2), d2) {
          let t2 = We(o2);
          for (let s3 = 0; s3 < d2; s3++) {
            let a3 = l3[s3];
            i2 = r2 === (u2 || 0) ? Math.abs((g2 || 0) - s3) : Math.abs(s3 - t2), e2 + i2 < n3 ? J.load(a3) : J.unload(a3);
          }
        }
      }
    ...
    e:
      for (let s2 = 0; s2 < t2.length; s2++) {
        ...
        for (let t3 = 0; t3 < n3.length; t3++) {
          if (n3[t3] === e2)
            break e;
          n3[t3].dataset.visibility !== "uncounted" && i2++;
        }
        if (a2 === e2)
          break;
        a2.classList.contains("stack") === false && a2.dataset.visibility !== "uncounted" && i2++;
      }
    return i2;
  }
  function lt() {
  ...
  function dt(e2) {
    let i2, s2 = u2, a2 = g2;
    if (e2) {
      let i3 = Ke(e2), n3 = i3 ? e2.parentNode : e2, r2 = ht();
  ...
  function Rt() {
    if (St(), m2 && y2.autoSlide !== false) {
      let e2 = m2.querySelector(".current-fragment");
      e2 || (e2 = m2.querySelector(".fragment"));
      let i2 = e2 ? e2.getAttribute("data-autoslide") : null, s2 = m2.parentNode ? m2.parentNode.getAttribute("data-autoslide") : null, a2 = m2.getAttribute("data-autoslide");
      i2 ? j2 = parseInt(i2, 10) : a2 ? j2 = parseInt(a2, 10) : s2 ? j2 = parseInt(s2, 10) : (j2 = y2.autoSlide, m2.querySelectorAll(".fragment").length === 0 && t(m2, "video, audio").forEach((e3) => {
  ...
  function Lt({ skipFragments: e2 = false } = {}) {
    S2.hasNavigatedHorizontally = true, y2.rtl ? (te.isActive() || e2 || ee.next() === false) && rt().left && Ge(u2 + 1, y2.navigationMode === "grid" ? g2 : void 0) : (te.isActive() || e2 || ee.prev() === false) && rt().left && Ge(u2 - 1, y2.navigationMode === "grid" ? g2 : void 0);
  }
  function Ct({ skipFragments: e2 = false } = {}) {
    S2.hasNavigatedHorizontally = true, y2.rtl ? (te.isActive() || e2 || ee.prev() === false) && rt().right && Ge(u2 - 1, y2.navigationMode === "grid" ? g2 : void 0) : (te.isActive() || e2 || ee.next() === false) && rt().right && Ge(u2 + 1, y2.navigationMode === "grid" ? g2 : void 0);
  }
  function xt({ skipFragments: e2 = false } = {}) {
    (te.isActive() || e2 || ee.prev() === false) && rt().up && Ge(u2, g2 - 1);
  }
  function Pt({ skipFragments: e2 = false } = {}) {
    S2.hasNavigatedVertically = true, (te.isActive() || e2 || ee.next() === false) && rt().down && Ge(u2, g2 + 1);
  }
  ...
  function Mt({ skipFragments: e2 = false } = {}) {
    if (S2.hasNavigatedHorizontally = true, S2.hasNavigatedVertically = true, e2 || ee.next() === false) {
      let t2 = rt();
      t2.down && t2.right && y2.loop && Ve() && (t2.down = false), t2.down ? Pt({ skipFragments: e2 }) : y2.rtl ? Lt({ skipFragments: e2 }) : Ct({ skipFragments: e2 });
    }
  }
  function Dt(e2) {
    y2.autoSlideStoppable && At();
  }
  function It(e2) {
    let t2 = e2.data;
  ...
  function Ot(e2) {
    je() && y2.loop === false ? (Ge(0, 0), kt()) : _ ? kt() : At();
  }
  const Ut = { VERSION: "4.3.1", initialize: ue, configure: Se, destroy: Le, sync: et, syncSlide: tt, syncFragments: ee.sync.bind(ee), slide: Ge, left: Lt, right: Ct, up: xt, down: Pt, prev: Nt, next: Mt, navigateLeft: Lt, navigateRight: Ct, navigateUp: xt, navigateDown: Pt, navigatePrev: Nt, navigateNext: Mt, navigateFragment: ee.goto.bind(ee), prevFragment: ee.prev.bind(ee), nextFragment: ee.next.bind(ee), on: Ce, off: xe, addEventListener: Ce, removeEventListener: xe, layout: qe, shuffle: st, availableRoutes: rt, availableFragments: ee.availableRoutes.bind(ee), toggleHelp: Fe, toggleOverview: te.toggle.bind(te), togglePause: _e, toggleAutoSlide: Qe, isFirstSlide: $e, isLastSlide: je, isLastVerticalSlide: Ve, isVerticalSlide: Ke, isPaused: Je, isAutoSliding: Ze, isSpeakerNotes: he.isSpeakerNotesWindow.bind(he), isOverview: te.isActive.bind(te), isFocused: de.isFocused.bind(de), isPrintingPDF: le.isPrintingPDF.bind(le), isReady: () => w2, loadSlide: J.load.bind(J), unloadSlide: J.unload.bind(J), showPreview: Te, hidePreview: He, addEventListeners: Ae, removeEventListeners: ke, dispatchEvent: Ne, getState: wt, setState: Et, getProgress: lt, getIndices: dt, getSlidesAttributes: mt, getSlidePastCount: ot, getTotalSlides: ft, getSlide: bt, getPreviousSlide: () => p2, getCurrentSlide: () => m2, getSlideBackground: yt, getSlideNotes: he.getSlideNotes.bind(he), getSlides: ct, getHorizontalSlides: ht, getVerticalSlides: ut, hasHorizontalSlides: vt, hasVerticalSlides: pt, hasNavigatedHorizontally: () => S2.hasNavigatedHorizontally, hasNavigatedVertically: () => S2.hasNavigatedVertically, addKeyBinding: ie.addKeyBinding.bind(ie), removeKeyBinding: ie.removeKeyBinding.bind(ie), triggerKey: ie.triggerKey.bind(ie), registerKeyboardShortcut: ie.registerKeyboardShortcut.bind(ie), getComputedSlideSize: Oe, getScale: () => C2, getConfig: () => y2, getQueryHash: d, getSlidePath: se.getHash.bind(se), getRevealElement: () => n2, getSlidesElement: () => V2.slides, getViewportElement: () => V2.viewport, getBackgroundsElement: () => G.element, registerPlugin: oe.registerPlugin.bind(oe), hasPlugin: oe.hasPlugin.bind(oe), getPlugin: oe.getPlugin.bind(oe), getPlugins: oe.getRegisteredPlugins.bind(oe) };
  return e(h2, __spreadProps(__spreadValues({}, Ut), { announceStatus: be, getStatusText: ye, print: le, focus: de, progress: ne, controls: ae, location: se, overview: te, fragments: ee, slideContent: J, slideNumber: Q, onUserInput: Dt, closeOverlay: He, updateSlidesVisibility: nt, layoutSlideContents: Be, transformSlides: Pe, cueAutoSlide: Rt, cancelAutoSlide: St })), Ut;
}
var $ = V;
var j = [];
